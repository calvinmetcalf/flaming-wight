...
$.couch.browserid.login(function(ev, er, userCtx) {
  ...
  $("#browserid").append("<li><i class='username icon-user'></i></li>").append("<li><a class='lougouter'><i class='farewell icon-remove'></i></a></li>");

  widget.unbind('click');

  var iurl = 'https://www.gravatar.com/avatar/' + Crypto.MD5($.trim(email).toLowerCase()) + "?s=16";
